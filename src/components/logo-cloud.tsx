    ...
    <section className="bg-background py-16">
      <div className="mx-auto max-w-5xl px-6">
        <div className="grid grid-cols-2 gap-y-6 md:grid-cols-4 lg:grid-cols-5">
          <LogoWrapper logos={aiLogos} group="ai" logoIndex={logoIndices[1]} />
          <LogoWrapper logos={hostingLogos} group="hosting" logoIndex={logoIndices[3]} />
          <LogoWrapper logos={paymentsLogos} group="payments" logoIndex={logoIndices[0]} />
          <LogoWrapper logos={streamingLogos} group="streaming" logoIndex={logoIndices[4]} />
          <LogoWrapper
            logos={otherLogos}
            group="other"
