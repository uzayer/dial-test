    ...
    <div className="py-6">
      <div className="flex flex-col gap-3">
        <div className="flex flex-col gap-2">
          <p className="max-w-4xl font-display text-xl leading-snug text-pretty md:text-2xl">
            {pub.title}
          </p>
                  ...
                  {[
                    {
                      ...
                      on: openAccessOnly,
                      toggle: () => handleOpenAccess(!openAccessOnly),
                    },
                    {
                      label: "Collaborations only",
                      on: collaborationsOnly,
                      toggle: () => handleCollaborations(!collaborationsOnly),
                    },
                  ].map((f) => (
                    <button
                      key={f.label}
